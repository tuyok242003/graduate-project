...
const addVariant = asyncHandler(async (req, res) => {
  ...
  const { color, price, title, thumb, images, countInStock, quantitySold, discount } = req.body
...
const updateVariant = asyncHandler(async (req, res) => {
  const { id } = req.params
  const { variantIndex, color, price, title, thumb, images, countInStock } = req.body.variants[0]
  if (
