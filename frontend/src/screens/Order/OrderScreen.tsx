                    ...
                    {dataOrder?.map((item: IOrderItem, index: number) => (
                      <ListGroup.Item key={index}>
                        <Row>
                          ...
                          <Col md={3}>
                            <Link to={`/product/${item.color}`} className="name-order">
                              {item.name}
                            </Link>
                          </Col>
                          <Col md={1}>
                          ...
                          <Col md={4}>${(item.qty * (item.variant ? item.variant.price : item.price)).toFixed(2)}</Col>
                        </Row>
                      </ListGroup.Item>
                    ))}
                  </ListGroup>
                ...
                <ListGroup.Item>
                  <Row>
                    ...
                    <Col>
                      ...
                      {dataOrder
                        ?.reduce(
                          (acc: number, item: IOrderItem) => acc + item.qty * (item.variant ? item.variant.price : item.price),
                          0,
                        )
                        .toFixed(2)}
                    </Col>
