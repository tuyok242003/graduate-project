...
const formFields: IFormField[] = [
  { controlId: 'voucherName', label: 'Name', type: 'text', placeholder:'Enter Name', value: state.voucherName, onChange: (e: React.ChangeEvent<HTMLInputElement>) => setState({ ...state, voucherName: e.target.value }) },
  { controlId: 'qty', label: 'Số lượng', type: 'number',placeholder:"Enter Qty", value: state.qty, onChange: (e: React.ChangeEvent<HTMLInputElement>) => setState({ ...state, qty: e.target.value }) },
  { controlId: 'discountAmount', label: 'Giảm (%)',placeholder:'Enter discountAmount', type: 'text', value: state.discountAmount, onChange: (e: React.ChangeEvent<HTMLInputElement>) => setState({ ...state, discountAmount: e.target.value }) },
];
